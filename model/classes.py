...
def get_weight_classes(classes, repartition_classes):
    """
    """
    return torch.Tensor(
        [
            sum(repartition_classes) / (len(classes) * nb_elements_class)
            for nb_elements_class in repartition_classes
        ]
    )

def get_pos_classes(repartition_classes):
    """
    """
    return torch.Tensor(
        [
            (sum(repartition_classes) - nb_elements_class) / nb_elements_class
            for nb_elements_class in repartition_classes
        ]
    )
...
REPARTITION_CLASSES_LVL_1 = [9037, 1810, 9681, 24965, 4856, 24128, 15544, 40540, 17424, 10647, 27623, 1661, 27512, 13571]
CLASSES_LVL_1_TO_ID = {c[0]: i for i, c in enumerate(CLASSES_LVL_1)}
WEIGHTS_CLASSES_LVL_1 = get_weight_classes(CLASSES_LVL_1, REPARTITION_CLASSES_LVL_1)
POS_WEIGHTS_LVL_1 = get_pos_classes(REPARTITION_CLASSES_LVL_1)
...
REPARTITION_CLASSES_LVL_2 = [644, 2495, 1691, 3776, 431, 154, 58, 311, 21, 41, 382, 14, 829, 2356, 2614, 770, 327, 3614, 3924, 7265, 823, 7565, 5388, 2023, 955, 1574, 304, 5411, 3099, 1174, 419, 1085, 8885, 4055, 569, 3816, 574, 1610, 1394, 3664, 1429, 2488, 1020, 6343, 1677, 2820, 3305, 1197, 2835, 451, 2517, 3016, 1667, 252, 770, 8564, 300, 1082, 1569, 1155, 1473, 1952, 7261, 1409, 540, 4789, 2932, 591, 2004, 1612, 3508, 840, 3446, 3362, 1726, 273, 573, 1188, 1191, 1294, 5942, 1881, 1906, 1753, 1618, 630, 257, 108, 275, 276, 745, 781, 5946, 1024, 2008, 2692, 4011, 2922, 8128, 3778, 883, 1611, 300, 649, 329, 465, 3513, 1061, 325, 657]
CLASSES_LVL_2_TO_ID = {c[0]: i for i, c in enumerate(CLASSES_LVL_2)}
WEIGHTS_CLASSES_LVL_2 = get_weight_classes(CLASSES_LVL_2, REPARTITION_CLASSES_LVL_2)
POS_WEIGHTS_LVL_2 = get_pos_classes(REPARTITION_CLASSES_LVL_2)
...
REPARTITION_CLASSES_LVL_3 = [644, 527, 287, 1277, 150, 254, 748, 393, 550, 263, 183, 200, 159, 358, 149, 302, 150, 159, 150, 203, 150, 283, 609, 58, 399, 1, 161, 6, 150, 114, 154, 58, 164, 71, 76, 4, 17, 41, 108, 12, 150, 112, 14, 10, 150, 182, 150, 184, 153, 251, 584, 150, 150, 150, 150, 150, 150, 509, 112, 370, 209, 310, 150, 540, 862, 173, 150, 470, 150, 327, 814, 687, 600, 1513, 509, 588, 247, 645, 269, 1516, 150, 337, 450, 152, 354, 284, 151, 150, 1089, 415, 256, 805, 1556, 201, 1065, 823, 1795, 1765, 1207, 440, 278, 613, 663, 804, 227, 1120, 596, 344, 506, 160, 1223, 285, 927, 376, 17, 690, 178, 131, 311, 202, 118, 74, 121, 121, 21, 618, 355, 232, 150, 152, 29, 150, 268, 238, 150, 154, 459, 294, 738, 696, 305, 2184, 375, 360, 1531, 1212, 151, 205, 158, 1016, 195, 224, 301, 585, 199, 182, 1221, 1204, 888, 846, 519, 1380, 436, 191, 820, 481, 176, 541, 737, 525, 1328, 983, 295, 187, 395, 174, 247, 555, 1417, 1343, 192, 62, 150, 214, 210, 583, 521, 225, 281, 662, 471, 261, 376, 1689, 864, 322, 413, 152, 158, 1119, 890, 401, 994, 203, 622, 398, 150, 468, 1536, 346, 145, 1972, 163, 408, 562, 593, 649, 594, 434, 835, 643, 540, 802, 150, 1080, 608, 775, 10, 682, 382, 815, 224, 474, 178, 226, 184, 755, 172, 151, 471, 451, 151, 409, 150, 151, 150, 151, 150, 150, 150, 151, 150, 150, 154, 150, 150, 151, 1800, 395, 519, 151, 214, 672, 338, 273, 170, 252, 150, 150, 150, 170, 150, 787, 809, 2056, 389, 810, 517, 352, 150, 991, 113, 287, 229, 744, 330, 150, 150, 382, 444, 256, 572, 702, 295, 429, 195, 150, 381, 475, 609, 389, 159, 186, 1607, 457, 773, 122, 1649, 593, 1161, 811, 368, 1051, 276, 940, 469, 213, 89, 238, 150, 355, 912, 2142, 245, 500, 485, 209, 2269, 300, 154, 171, 420, 388, 186, 483, 150, 316, 227, 254, 150, 187, 150, 154, 219, 150, 124, 1, 1, 174, 150, 152, 531, 487, 264, 279, 254, 1292, 401, 169, 158, 29, 484, 667, 403, 511, 268, 356, 637, 604, 254, 1107, 955, 715, 331, 39, 406, 752, 355, 174, 150, 33, 3, 45, 42, 423, 150, 211, 150, 157, 160, 196, 150, 164, 631, 560, 150, 368, 770, 6, 315, 364, 151, 463, 610, 166, 1512, 150, 259, 432, 1298, 222, 212, 158, 261, 1250, 453, 340, 406, 230, 174, 303, 447, 1306, 275, 344, 999, 238, 242, 150, 56, 49, 152, 18, 49, 27, 14, 15, 77, 32, 151, 276, 15, 152, 26, 48, 120, 18, 63, 97, 55, 151, 448, 333, 470, 519, 2718, 527, 876, 313, 523, 193, 831, 381, 745, 729, 153, 915, 1082, 695, 493, 175, 462, 637, 757, 159, 813, 260, 255, 238, 150, 692, 340, 893, 207, 402, 545, 875, 1009, 666, 3089, 824, 208, 249, 27, 636, 917, 259, 1936, 174, 492, 280, 603, 295, 226, 1090, 150, 150, 150, 49, 150, 150, 150, 103, 139, 87, 152, 162, 151, 893, 523, 810, 335, 952, 250, 150, 502, 159, 175, 150, 200, 144, 313]
CLASSES_LVL_3_TO_ID = {c[0]: i for i, c in enumerate(CLASSES_LVL_3)}
WEIGHTS_CLASSES_LVL_3 = get_weight_classes(CLASSES_LVL_3, REPARTITION_CLASSES_LVL_3)
POS_WEIGHTS_LVL_3 = get_pos_classes(REPARTITION_CLASSES_LVL_3)
